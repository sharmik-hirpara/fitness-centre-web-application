<?php
	...
	if(isset($_POST['first_name'])) {
		...
		if(isset($_POST['product_features'])) {
			...
			if ($productFeatures == "group_activity" || $productFeatures == "Group Activity")
				$productFeatures = "Group Activity";
			else
				$productFeatures = "Personal Training";
	...
	function calculateCost() {
		...
		if($_SESSION["no_of_members"] != "") {
			if($_SESSION['product_features'] == "Group Activity") {
			...
			else if($_SESSION['product_features'] == "Personal Training") {
				if($_SESSION['category'] == "Gymnastics")
