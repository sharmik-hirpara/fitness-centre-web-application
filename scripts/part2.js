...
function addressValidate(street_name, suburb, state, pin_code)
{
	...
	if(!street_name.match(/^[a-zA-Z ]+$/))
	{
		result = result + "Street name must contain alpha characters.\n";
	}
...
function calculateCost()
{
	...
	if(sessionStorage.product_features == "group_activity")
	{
	...
	else if(sessionStorage.product_features == "personal_training")
	{
		if(sessionStorage.category == "gymnastics")
		{
